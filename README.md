...
- штатный `YANDEX EDGE -> xray-proxy` flow без ручных live-патчей
- синхронизированный owner deploy + invite + import path для `realityYandexEdgeProxy`
- усиленные diagnostics и health checks для edge-attach сценариев
...
- [Release notes 0.6.1](./docs/releases/v0.6.1.md)
