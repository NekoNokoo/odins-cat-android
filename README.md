...
- основной Android-first путь теперь строится вокруг `Yandex edge -> xhttp -> origin`
- `Yandex camo` закреплён как основной whitelist-facing режим
- direct bypass для российских сайтов работает не только в `Yandex edge`, но и в `VLESS REALITY` и `VK proxy`
- обновлён стартовый экран и шлифовка Android UX
...
- [Release notes 0.7.0](./docs/releases/v0.7.0.md)

## Что будет в GitHub Release

В релиз `0.6.1` рекомендуется прикладывать:
...
- Проверенный Android label релиза: `Odin's Cat 0.6.1`.
