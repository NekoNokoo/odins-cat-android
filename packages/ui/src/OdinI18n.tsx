...
const dictionaries = {
  ru: {
    ...
    realityConfigMode: "Режим REALITY-конфига",
    realityFeatures: "Активные REALITY-фичи",
  ...
  en: {
    ...
    realityConfigMode: "REALITY config mode",
    realityFeatures: "REALITY active features",
    alwaysOnMode: "Always-on VPN",
    lockdownMode: "Lockdown VPN",
